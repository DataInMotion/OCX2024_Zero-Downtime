...
public class CarSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CarPackage.CAR_RESPONSE: {
				CarResponse carResponse = (CarResponse)theEObject;
				T result = caseCarResponse(carResponse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseCarResponse(CarResponse object) {
		return null;
	}
