 ...
 * <!-- end-user-doc -->
 * @see org.gecko.talk.car.model.car.CarPackage
 * @generated
 */
public class CarAdapterFactory extends AdapterFactoryImpl {
	...
	protected CarSwitch<Adapter> modelSwitch =
		new CarSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCarResponse(CarResponse object) {
				return createCarResponseAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.gecko.talk.car.model.car.Car <em>Car</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.gecko.talk.car.model.car.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.gecko.talk.car.model.car.CarResponse <em>Response</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCarResponseAdapter() {
		return null;
	}
