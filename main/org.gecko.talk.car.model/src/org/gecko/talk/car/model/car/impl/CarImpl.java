...
public class CarImpl extends MinimalEObjectImpl.Container implements Car {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarPackage.CAR__ID, oldId, id));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarPackage.CAR__TYPE, oldType, type));
	}
	...
	public NotificationChain basicSetOwner(Person newOwner, NotificationChain msgs) {
		...
		owner = newOwner;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarPackage.CAR__OWNER, oldOwner, newOwner);
	...
	public void setOwner(Person newOwner) {
		if (newOwner != owner) {
			...
			if (owner != null)
				msgs = ((InternalEObject)owner).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CarPackage.CAR__OWNER, null, msgs);
			if (newOwner != null)
				msgs = ((InternalEObject)newOwner).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CarPackage.CAR__OWNER, null, msgs);
			msgs = basicSetOwner(newOwner, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarPackage.CAR__OWNER, newOwner, newOwner));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CarPackage.CAR__ID:
				return getId();
			case CarPackage.CAR__TYPE:
				return getType();
			case CarPackage.CAR__OWNER:
				return getOwner();
